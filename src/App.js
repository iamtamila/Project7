...
var foursquare = require("react-foursquare")({
  clientID: "UJKUVOKEUGNJVWIBOSLM3C0SXN30G3PLUDCT2BICRJ3YQVAQ",
  clientSecret: "ZBCU3ISI0VOS5PM3GBXJDRU5QBW1LUKYDZ2EZ5FVMJ2P2X4K"
});
var params = {
...
class App extends Component {
  ...
  // Take information from Foursquare API
  componentDidMount() {
    foursquare.venues
      .getVenues(params)
      .then(res => {
  ...
  //Show marker of item clicked on the list of locations.
